...
public class EngineGui {
    public static Inventory MAIN_GUI = Bukkit.createInventory(null, 3*9, ""+ChatColor.COLOR_CHAR+"6UK Bank");;
    public static Inventory DEPOSIT_GUI = Bukkit.createInventory(null, 3*9, ""+ChatColor.COLOR_CHAR+"6UK Bank");;
    public static Inventory WITHDRAW_GUI = Bukkit.createInventory(null, 3*9, ""+ChatColor.COLOR_CHAR+"6UK Bank");;
    /**
     * @author Plugner
    ...
    public void hookDeposit(Player p) {
        Inventory inventory  = DEPOSIT_GUI;
    ...
    public void hookWithdraw(Player p) {
        Inventory inventory = WITHDRAW_GUI;
